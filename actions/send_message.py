...
def send_message(
    ...
    # Zero-Trust guard for destructive/external communication
    try:
        ...
        guard(
            command=f"send_message to {receiver} via {platform}",
            confirmed=confirmed,
            pin=pin,
        ...
        return f"Message send refused by security guard: {pe}"
